...
dist: 
	@test -d .tmp/sst_str01_lib_d1.0.0 || mkdir -p .tmp/sst_str01_lib_d1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/sst_str01_lib_d1.0.0/ && (cd `dirname .tmp/sst_str01_lib_d1.0.0` && $(TAR) sst_str01_lib_d1.0.0.tar sst_str01_lib_d1.0.0 && $(COMPRESS) sst_str01_lib_d1.0.0.tar) && $(MOVE) `dirname .tmp/sst_str01_lib_d1.0.0`/sst_str01_lib_d1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/sst_str01_lib_d1.0.0
